    ...
    <>
      <div className=" flex flex-1 justify-center items-center  min-h-screen">
        <div className=" flex bg-white rounded-xl shadow-2xl h-96 w-250 gap-6">
          ...
          <div className=" h-full w-140 bg-gradient-to-tr from-slate-900 via-slate-700 to-slate-800 text-white flex flex-col justify-center items-center gap-6 p-4 rounded-r-xl ">
